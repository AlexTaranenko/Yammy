...
#define IMAGE_VIEW_ICON_FRAME_IPHONE_X          CGRectMake(15.0f, 32.0f, 20.0f, 20.0f)

#define DRAG_HANDLER_FRAME_IPHONE_X             CGRectMake([[UIScreen mainScreen] bounds].size.width/2-30,NOTIFICATION_VIEW_FRAME_HEIGHT + 24 - 5,60,3)
#define DRAG_HANDLER_FRAME                      CGRectMake([[UIScreen mainScreen] bounds].size.width/2-30,NOTIFICATION_VIEW_FRAME_HEIGHT-5,60,3)

#define LABEL_TITLE_FRAME                       CGRectMake(/*45.0f*/10.0f, 3.0f, [[UIScreen mainScreen] bounds].size.width - /*45.0f*/20.0f, 26.0f)
#define LABEL_TITLE_FRAME_IPHONE_X              CGRectMake(/*45.0f*/10.0f, 27.0f, [[UIScreen mainScreen] bounds].size.width - /*45.0f*/20.0f, 26.0f)
#define LABEL_TITLE_FRAME_WITHOUT_IMAGE         CGRectMake(/*5.0f*/10.0f, 3.0f, [[UIScreen mainScreen] bounds].size.width - /*5.0f*/20.0f, 26.0f)
#define LABEL_TITLE_FRAME_WITHOUT_IMAGE_IPHONE_X         CGRectMake(10.0f, 32.0f, [[UIScreen mainScreen] bounds].size.width - /*5.0f*/20.0f, 26.0f)

#define LABEL_MESSAGE_FRAME_HEIGHT              35.0f
#define LABEL_MESSAGE_FRAME                     CGRectMake(/*45.0f*/10.0f, 25.0f, [[UIScreen mainScreen] bounds].size.width - /*45.0f*/20.0f, LABEL_MESSAGE_FRAME_HEIGHT)
#define LABEL_MESSAGE_FRAME_IPHONE_X            CGRectMake(/*45.0f*/10.0f, 49.0f, [[UIScreen mainScreen] bounds].size.width - /*45.0f*/20.0f, LABEL_MESSAGE_FRAME_HEIGHT)
#define LABEL_MESSAGE_FRAME_WITHOUT_IMAGE       CGRectMake(/*5.0f*/10.0f, 25.0f, [[UIScreen mainScreen] bounds].size.width - /*5.0f*/20.0f, LABEL_MESSAGE_FRAME_HEIGHT)
#define LABEL_MESSAGE_FRAME_WITHOUT_IMAGE_IPHONE_X       CGRectMake(10.0f, 54.0f, [[UIScreen mainScreen] bounds].size.width - /*5.0f*/20.0f, LABEL_MESSAGE_FRAME_HEIGHT)
...
- (instancetype)init
{
  self = [super initWithFrame:CGRectMake(0.0f, 0.0f, [[UIScreen mainScreen] bounds].size.width, IS_IPHONE_X ? NOTIFICATION_VIEW_FRAME_HEIGHT + 24 :  NOTIFICATION_VIEW_FRAME_HEIGHT)];
    if (self) {
...
- (void)setUpUI
{
  ...
  self.frame = CGRectMake(0.0f, 0.0f, [[UIScreen mainScreen] bounds].size.width, IS_IPHONE_X ? NOTIFICATION_VIEW_FRAME_HEIGHT + 24 : NOTIFICATION_VIEW_FRAME_HEIGHT);
    
    /// Icon
    if (!_imgIcon) {
        _imgIcon = [[UIImageView alloc] init];
    }
  _imgIcon.frame = IS_IPHONE_X ? IMAGE_VIEW_ICON_FRAME_IPHONE_X : IMAGE_VIEW_ICON_FRAME;
  ...
  _lblTitle.frame = IS_IPHONE_X ? LABEL_TITLE_FRAME_IPHONE_X : LABEL_TITLE_FRAME;
  ...
  _lblMessage.frame = IS_IPHONE_X ? LABEL_MESSAGE_FRAME_IPHONE_X : LABEL_MESSAGE_FRAME;
  ...
  _dragHandler.frame = IS_IPHONE_X ? DRAG_HANDLER_FRAME_IPHONE_X : DRAG_HANDLER_FRAME;
...
- (void)showNotificationViewWithImage:(UIImage *)image title:(NSString *)title message:(NSString *)message isAutoHide:(BOOL)isAutoHide onTouch:(void (^)())onTouch
{
    ...
    if (image) {
      ...
      _lblTitle.frame =IS_IPHONE_X ? LABEL_TITLE_FRAME_WITHOUT_IMAGE_IPHONE_X : LABEL_TITLE_FRAME_WITHOUT_IMAGE;
      _lblMessage.frame = IS_IPHONE_X ? LABEL_MESSAGE_FRAME_WITHOUT_IMAGE_IPHONE_X : LABEL_MESSAGE_FRAME_WITHOUT_IMAGE;
    }
...
- (void)notificationViewDidPan:(UIPanGestureRecognizer *)gesture
{
    if (gesture.state == UIGestureRecognizerStateEnded){
      ...
      CGFloat height = IS_IPHONE_X ? NOTIFICATION_VIEW_FRAME_HEIGHT + 24 : NOTIFICATION_VIEW_FRAME_HEIGHT;
        if (newCenter.y >= (-1 * height/2) && newCenter.y <= height/2) {
...
{
    CGSize size = [_lblMessage sizeThatFits:CGSizeMake([[UIScreen mainScreen] bounds].size.width - /*45.0f*/20.0f, MAXFLOAT)];
