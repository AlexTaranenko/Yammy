...
static const CGFloat kPreloadViewCount = 2.0f;//3.0f; // Default
static const CGFloat kSecondCard_Scale = 0.f;//0.98f; // Default
static const CGFloat kTherdCard_Scale = 0.f;//0.96f; // Default
static const CGFloat kCard_Margin = 7.0f; // Default
static const CGFloat kDragCompleteCoefficient_width_default = 0.7;//0.8f; // Default
static const CGFloat kDragCompleteCoefficient_height_default = 0.6f; // Default
...
- (void)cardViewDirectionAnimation:(YSLDraggableDirection)direction isAutomatic:(BOOL)isAutomatic undoHandler:(void (^)(void))undoHandler
{
  ...
  if (direction == YSLDraggableDirectionDefault) {
    ...
    [UIView animateWithDuration:0.9 // Default 0.55
                          delay:0.0
         usingSpringWithDamping:0.9 // Default 0.6
